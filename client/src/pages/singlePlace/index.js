    ...
    return (
      <>
        ...
        <div className="buttons-container">
          <Link to= "/search"><span className="buttons-container__back">
            <Icon type="arrow-left" />
            <span className="buttons-container__back__text">
              Back to results
            </span>
          </span></Link>
          <Link to="/review"><Button onClick={() => {}} className="buttons-container__add">
        ...
        <p className="heading-name-location">{`${name}, ${country}, ${city}`} </p>
        <a href={website} className="heading-website">{website}</a>
        <div className="singlePlace-slider">
        <ImageCarousel slides={images} smallTitle />
        </div>
        <span className="recommended-by-text">Recommended by {reviews.length} contributors</span>
        <Link to="/review"><Fab /></Link>
        <div className="reviews-container">
        {reviews.map(({id, reviewee, reviewDate, title, magicalFactors, tripDetails, reviewText, preservation})=>
        <Review key={id} reviewee={reviewee} reviewDate={reviewDate} title={title} magicalFactors={magicalFactors} tripDetails={tripDetails} reviewText={reviewText} preservation={preservation} />
    )}
        </div>
      </>
    );
